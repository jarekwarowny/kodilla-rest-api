...
class TrelloClientTest {
    ...
    public void shouldFetchTrelloBoards() throws URISyntaxException {
        ...
        when(trelloConfig.getTrelloUsername()).thenReturn("jarek991");


        TrelloBoardDto[] trelloBoards = new TrelloBoardDto[1];
        trelloBoards[0] = new TrelloBoardDto("test_id", "Kodilla", new ArrayList<>());

        URI uri = new URI("http://test.com/members/jarek991/boards?key=test&token=test&fields=name,id&lists=all");
